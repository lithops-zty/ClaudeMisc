...
def plot_2d_fft_maps(results, output_dir, timestep='500', layer='mid_block'):
...
def plot_2d_fft_detailed(extractor, inputs, output_dir):
    ...
    for name in available:
        ...
        if 'mid_block' not in features:
            continue

        feat_map = features['mid_block'][0]  # (C, H, W)
...
def plot_frequency_energy_distribution(results, output_dir, timestep='500', layer='mid_block'):
